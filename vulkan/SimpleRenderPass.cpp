...
void vulkan::SimpleRenderPass::init() {
    initRenderPass();
    initSetLayouts();
    initPipelineLayout();
    initPipeline();
...
void vulkan::SimpleRenderPass::initRenderPass() {
...
void vulkan::SimpleRenderPass::initSetLayouts() {
...
void vulkan::SimpleRenderPass::initPipelineLayout() {
...
void vulkan::SimpleRenderPass::initPipeline() {
    ...
    PipelineColorBlendAttachmentState noBlend;
    noBlend.blendEnable = VK_FALSE;
    noBlend.colorWriteMask = ColorComponentFlags()
                             | ColorComponentFlagBits::eR
                             | ColorComponentFlagBits::eG
                             | ColorComponentFlagBits::eB
                             | ColorComponentFlagBits::eA;
    vector<PipelineColorBlendAttachmentState> blendAttachments{noBlend};
...
vulkan::SimpleRenderPass::~SimpleRenderPass() {
    if (opaquePipeline) {
